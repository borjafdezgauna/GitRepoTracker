...
namespace UnitTests
{
    ...
    public class IncrementalStatsTests
    {
        ...
        public void IncrementalTestsCoverage()
        {
            ...
            commit.Stats.UserTestsResults.CoveragePercent = 50;
            commits.Add(commit);
            commit = new Commit() { Author = "Pepito", Id = "5" };
            commit.Stats.Builds = true;
            commit.Parents.Add("4");
            commit.Stats.UserTestsResults.CoveragePercent = 40;
            commits.Add(commit);
            commit = new Commit() { Author = "Pepito", Id = "6" };
            commit.Stats.Builds = true;
            commit.Parents.Add("5");
            commit.Stats.UserTestsResults.CoveragePercent = 60;
            commits.Add(commit);
        ...
        public void IncrementalStatsDeadlines()
        {
            ...
            commit.Stats.Builds = true;
            commit.Parents.Add("1");
            commit.Stats.DeadlineTestsResults.Add(new TestResults() { Passed = new List<string>() { "Test1" } });
            commits.Add(commit);
            commit = new Commit() { Author = "Pepito", Id = "3" };
            commit.Stats.Builds = false;
            commit.Parents.Add("2");
            ...
            commit.Stats.Builds = true;
            commit.Parents.Add("3");
            commit.Stats.DeadlineTestsResults.Add(new TestResults() { Passed = new List<string>() { "Test1", "Test2" } });
            commits.Add(commit);
            commit = new Commit() { Author = "Pepito", Id = "5" };
            commit.Stats.Builds = true;
            commit.Parents.Add("4");
            ...
            commit.Stats.Builds = true;
            commit.Parents.Add("5");
            commit.Stats.DeadlineTestsResults.Add(new TestResults() { Passed = new List<string>() { "Test1", "Test2", "Test3" } });
            commits.Add(commit);
